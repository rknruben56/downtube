...
// Source: github.com/rknruben56/downtube/download (interfaces: Downloader)
...
import (
	...
	download "github.com/rknruben56/downtube/download"
)
...
func (m *MockDownloader) Download(arg0 string) (download.Result, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Download", arg0)
	ret0, _ := ret[0].(download.Result)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
